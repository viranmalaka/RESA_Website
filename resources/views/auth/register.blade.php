...
@section('body')
    ...
    {{ Form::textarea('address', isset($input) ? $input['address'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('address'))<p>{{ $messages->first('address') }}</p> @endif @endif
    <br>
    {{ Form::select('field', [
    ...
    @if(isset($messages)) @if($messages->has('field'))<p>{{ $messages->first('field') }}</p> @endif @endif
    <br>

    {{ Form::label('telephone', 'Telephone :') }}
    {{ Form::text('telephone', isset($input) ? $input['telephone'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('telephone'))<p>{{ $messages->first('telephone') }}</p> @endif @endif
    <br>
    ...
    @if(isset($messages)) @if($messages->has('gender'))<p>{{ $messages->first('gender') }}</p> @endif @endif
    <br>
    {{ Form::select('level', [
    0 => 'Juniors',
    1 => 'Level - 1',
    ...
    @if(isset($messages)) @if($messages->has('level'))<p>{{ $messages->first('level') }}</p> @endif @endif
    <br>

    {{ Form::label('about', 'About You :') }}
    {{ Form::textarea('about', isset($input) ? $input['about'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('about'))<p>{{ $messages->first('about') }}</p> @endif @endif
    <br>

    {{ Form::label('p_pic', 'Profile Picture :') }}
    {{ Form::file('p_pic', ['class' => 'field']) }}
    @if(isset($messages)) @if($messages->has('p_pic'))<p>{{ $messages->first('p_pic') }}</p> @endif @endif
    <br>

    {{ Form::label('facebook_link', 'facebook :') }}
    {{ Form::url('facebook_link', isset($input) ? $input['facebook_link'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('facebook_link'))<p>{{ $messages->first('facebook_link') }}</p> @endif @endif
    <br>
    {{ Form::label('linkedin_link', 'linkedin :') }}
    {{ Form::url('linkedin_link', isset($input) ? $input['linkedin_link'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('linkedin_link'))<p>{{ $messages->first('linkedin_link') }}</p> @endif @endif
    <br>
    {{ Form::label('twitter_link', 'twitter :') }}
    {{ Form::url('twitter_link', isset($input) ? $input['twitter_link'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('twitter_link'))<p>{{ $messages->first('twitter_link') }}</p> @endif @endif
    <br>
    {{ Form::label('instagram_link', 'instagram :') }}
    {{ Form::url('instagram_link', isset($input) ? $input['instagram_link'] : null, ['class' => '']) }}
    @if(isset($messages)) @if($messages->has('instagram_link'))<p>{{ $messages->first('instagram_link') }}</p> @endif @endif
    <br>
    ...
    @if(isset($messages)) @if($messages->has('password'))<p>{{ $messages->first('password') }}</p> @endif @endif
    <br>
